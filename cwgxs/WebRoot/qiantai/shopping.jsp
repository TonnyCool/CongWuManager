...
%><script>alert('恭喜您，购物成功!')</script><%
 ...
 %>
  ...
  <table  border="1" cellpadding="1" cellspacing="1" align="center" width="620">
		<tr bgcolor="#ffe2a6">
			<td align="center" valign="middle" colspan="6" background="img/tu_bg.gif">
			<font face="华文行楷" size="3">我的购物车</font></td>
		</tr>
		<tr bgcolor="#ffe2a6">
			<td align="center" valign="middle">宠物狗名称</td>
